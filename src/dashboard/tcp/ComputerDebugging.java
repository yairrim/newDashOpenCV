...
public class ComputerDebugging {
    ...
    public static void sendImageProcessing(double brightness, double contrast, double saturation, double orientation){
        messageBuilder.append("IMAGE,");
        messageBuilder.append(df.format(brightness));
        messageBuilder.append(",");
        messageBuilder.append(df.format(contrast));
        messageBuilder.append(",");
        messageBuilder.append(df.format(saturation));
        messageBuilder.append(",");
        messageBuilder.append(df.format(orientation));
        messageBuilder.append("%");
    }
}
